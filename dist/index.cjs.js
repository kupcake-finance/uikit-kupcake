...
var Flex$1 = styled__default['default'].div(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  display: flex;\n"], ["\n  display: flex;\n"])));
var SpacedButton = styled__default['default'](Button)(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  margin-right: 10px;\n\n  &:hover {\n    color: #06c;\n  }\n"], ["\n  margin-right: 10px;\n\n  &:hover {\n    color: #06c;\n  }\n"])));
var UserBlock = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout; _a.cakePriceUsd;
    var _b = useWalletModal(login, logout, account), onPresentConnectModal = _b.onPresentConnectModal, onPresentAccountModal = _b.onPresentAccountModal;
    var accountEllipsis = account ? account.substring(0, 4) + "..." + account.substring(account.length - 4) : null;
    return (React__default['default'].createElement(Flex$1, null, account ? (React__default['default'].createElement(SpacedButton, { size: "sm", variant: "primary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(SpacedButton, { size: "sm", onClick: function () {
...
styled__default['default'](Panel)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  ", " {\n    display: flex;\n  }\n  ", " {\n    display: flex;\n  }\n\n  ", " {\n    display: none;\n  }\n"], ["\n  ", " {\n    display: flex;\n  }\n  ", " {\n    display: flex;\n  }\n\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.xs;
}, function (_a) {
    var theme = _a.theme;
...
var NewLogo = styled__default['default'](Logo$1)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  ", " {\n    display: flex;\n  }\n  ", " {\n    display: flex;\n  }\n\n  ", " {\n    display: none;\n  }\n"], ["\n  ", " {\n    display: flex;\n  }\n  ", " {\n    display: flex;\n  }\n\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.xs;
}, function (_a) {
    var theme = _a.theme;
...
var Menu = function (_a) {
    ...
    var NewNavUl = styled__default['default'].ul(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n    list-style: none;\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    width: 100%;\n\n    ", " {\n      display: none;\n    }\n    ", " {\n      display: none;\n    }\n\n    ", " {\n      display: flex;\n    }\n  "], ["\n    list-style: none;\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    width: 100%;\n\n    ", " {\n      display: none;\n    }\n    ", " {\n      display: none;\n    }\n\n    ", " {\n      display: flex;\n    }\n  "])), function (_a) {
        var theme = _a.theme;
        return theme.mediaQueries.xs;
    }, function (_a) {
        var theme = _a.theme;
    ...
    var NewNavLi = styled__default['default'].li(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n    color: #f5f5f7;\n    opacity: 0.8;\n    width: 80px;\n    max-width: 10%;\n    text-align: center;\n\n    &:hover {\n      opacity: 1;\n    }\n  "], ["\n    color: #f5f5f7;\n    opacity: 0.8;\n    width: 80px;\n    max-width: 10%;\n    text-align: center;\n\n    &:hover {\n      opacity: 1;\n    }\n  "])));
    var NewNavA = styled__default['default'].a(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n    color: #f5f5f7;\n    text-align: center;\n  "], ["\n    color: #f5f5f7;\n    text-align: center;\n  "])));
    ...
    var SpacedButton = styled__default['default'](Button)(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n    margin-left: 10px;\n    width: 175px;\n\n    &:hover {\n      color: #06c;\n    }\n  "], ["\n    margin-left: 10px;\n    width: 175px;\n\n    &:hover {\n      color: #06c;\n    }\n  "])));
    var HeaderFlex = styled__default['default'](Flex)(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n    margin: 0 auto;\n    width: 100%;\n    max-width: 2500px;\n  "], ["\n    margin: 0 auto;\n    width: 100%;\n    max-width: 2500px;\n  "])));
    return (React__default['default'].createElement(Wrapper$2, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(NewLogo, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React__default['default'].createElement(HeaderFlex, { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
                React__default['default'].createElement(React__default['default'].Fragment, null, cakePriceUsd ? (React__default['default'].createElement(React__default['default'].Fragment, null,
                    React__default['default'].createElement(SpacedButton, { size: "sm", variant: "transparent" },
                        React__default['default'].createElement(Icon$v, { width: "20px", mr: "8px" }), "$ " + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(SpacedButton, { size: "sm" },
                    React__default['default'].createElement(Skeleton, { width: 80, height: 24 })))),
                React__default['default'].createElement(React__default['default'].Fragment, null,
                    React__default['default'].createElement(NewNavUl, null,
                        React__default['default'].createElement(NewNavLi, null,
                            React__default['default'].createElement(NewNavA, { href: "/" },
                                React__default['default'].createElement("img", { src: "/images/common/token-white.png", alt: "Token", width: "17px" }))),
                        React__default['default'].createElement(NewNavLi, null,
                            React__default['default'].createElement(NewNavA, { href: "/" }, "Home")),
                        React__default['default'].createElement(NewNavLi, null,
                            React__default['default'].createElement(NewNavA, { href: "/swap" }, "Swap")),
                        React__default['default'].createElement(NewNavLi, null,
                            React__default['default'].createElement(NewNavA, { href: "/liquidity" }, "Liquidity")),
                        React__default['default'].createElement(NewNavLi, null,
                            React__default['default'].createElement(NewNavA, { href: "/farms" }, "Farm")),
                        React__default['default'].createElement(NewNavLi, null,
                            React__default['default'].createElement(NewNavA, { href: "/chart" }, "Chart")),
                        React__default['default'].createElement(NewNavLi, null,
                            React__default['default'].createElement(NewNavA, { href: "/" }, "Doc")))),
                React__default['default'].createElement(React__default['default'].Fragment, null,
